import React, { useLayoutEffect, useRef } from 'react'; // 1. Changed to useLayoutEffect
...
const Hero = () => {
  ...
  useLayoutEffect(() => {
    // 2. Use gsap.context for better React cleanup and to avoid double-triggering
  ...
  return (
    ...
    >
      ...
      <style jsx global>{`
        ...
        /* 3. ADDED INITIAL STATE CSS TO PREVENT GLITCH */
        .l-stem { transform: scaleY(0); }
        .stroke-left, .stroke-right { transform: scaleX(0); }
        .name-left, .name-right, .sub-label { opacity: 0; }
