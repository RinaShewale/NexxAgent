...
export default function FileTreeNode({ node, depth = 0, onFileClick }) {
  ...
  // Custom logic to handle folder vs file icons from the utility
    ...
    <div className="select-none font-sans">
      ...
      >
        ...
        {isFolder ? (
          ...
          <div className="w-3 shrink-0" /> /* Spacer to align files with folders */
        )}

        {/* File/Folder Icon */}
        <div className="flex items-center justify-center w-4 h-4 shrink-0 transition-opacity group-hover:opacity-100 opacity-80">
          {isFolder ? (
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={expanded ? "#F8FAFA" : "#818263"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M4 20h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.93a2 2 0 0 1-1.66-.9l-.82-1.2A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13c0 1.1.9 2 2 2Z"/>
            </svg>
          ) : (
             <span className="text-[11px] font-mono font-bold" style={{ color: color || '#818263' }}>
               {/* Use icon from util, falling back to a generic file icon if it looks like an emoji */}
      ...
      {/* Recursive Children with Expansion Animation */}
